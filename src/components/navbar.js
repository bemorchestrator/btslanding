            ...
            <div className="container">
                ...
                <ul className="buy-button list-none mb-0">
                    ...
                    <li className="md:inline hidden ps-1 mb-0 ">
                        <a href="https://app.betterteachingsolutions.com/register" target="_blank" rel="noopener noreferrer" className="py-[6px] px-4 inline-block items-center justify-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-amber-400 hover:bg-amber-500 border border-amber-400 hover:border-amber-500 text-white font-semibold">Signup</a>
                    </li>
                </ul>
