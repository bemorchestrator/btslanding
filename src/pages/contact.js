...
export default function Contact(){
    ...
    const [formData, setFormData] = useState({
        ...
        subject: '',
        message: '',
        // Honeypot field - not displayed to users, only bots will fill this
        website: ''
    });
    ...
    const validateForm = useCallback(() => {
        ...
        // Check for submission time (bot detection - if filled too quickly)
        const timeElapsed = Date.now() - formStartTime;
        if (timeElapsed < 3000) { // Less than 3 seconds is suspiciously fast
        ...
        // Count URLs in message (too many links is suspicious)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // If no siteKey is provided, skip reCAPTCHA (development mode)
            ...
            const response = await fetch('/api/contact', {
                ...
                body: JSON.stringify({
                    ...
                    website: formData.website // Honeypot field for bot detection
                })
            });
            ...
            setStatus({ 
                loading: false, 
                success: false, 
                error: error.message || 'Failed to send message. Please check your connection and try again.' 
            });
        }
    };
                        ...
                        <div className="lg:ms-5">
                            <div className="bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-700 p-6">
                                ...
                                <form onSubmit={handleSubmit}>
                                    {/* Hidden reCAPTCHA v3 - invisible to users */}
                                    {siteKey && (
                                        <ReCAPTCHA
                                            ref={recaptchaRef}
                                            size="invisible"
                                    ...
                                    <div className="mb-4">
                                        <button 
                                            type="submit" 
                                            disabled={status.loading || (siteKey && (!recaptchaLoaded || !!recaptchaError))}
