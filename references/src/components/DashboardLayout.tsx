...
type DashboardLayoutProps = {
  ...
  currentView: 'dashboard' | 'categories' | 'articles';
  setCurrentView: (view: 'dashboard' | 'categories' | 'articles') => void;
};
    ...
    <div className="flex h-screen bg-[#0a0a0a]">
      ...
      <div className="w-64 bg-[#1a1a1a] border-r border-[#2a2a2a] flex flex-col">
        ...
        <div className="p-4 border-t border-[#2a2a2a]">
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:bg-[#2a2a2a] hover:text-white transition-colors">
            <LogOut size={20} />
            <span>Logout</span>
          </button>
        </div>
